...
// OUTBOUND: tiles.openfreemap.org, fetched by native MapLibre rather than by
// any Dart code here. Sends: the coordinates of the tiles on screen. No key,
// no cookie, no account. The house marker is drawn locally and never sent.
...
class _FlightMapViewState extends State<FlightMapView> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: <Widget>[
        MapLibreMap(
          styleString: Endpoints.mapStyleUrl,
