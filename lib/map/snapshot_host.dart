...
// OUTBOUND: tiles.openfreemap.org, as in `live_map.dart` and for the same
// reason: MapLibre needs the basemap to draw. The tracks, the house and the
// legend are painted over it in Dart and go nowhere.
