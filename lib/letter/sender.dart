...
// OUTBOUND: the user's own mail app, and only when they press send.
//
// This is the one place personal data leaves the device, and it is the whole
// point of the app: the name, the address, the recording and the map go into a
// draft, and the user's own account sends it under their own reply address.
// Nothing here talks to a server of ours, because there is not one.
